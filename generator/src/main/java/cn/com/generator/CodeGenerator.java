...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3306/insurance_dev?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    // 连接数据库的驱动类
    ...
    // 作者名
    public static String author = "fu_yuqi";
